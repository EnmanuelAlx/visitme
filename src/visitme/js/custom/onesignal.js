! function (e) {
  ...
  var s = n(47),
    ...
    p = function () {
      ...
      return e.getBuildEnv = function () {
        ...
        return i(this, void 0, void 0, function () {
          return r(this, function (e) {
            switch (e.label) {
              case 0:
                return window !== window.top && "serviceWorker" in navigator && void 0 !== navigator.serviceWorker.getRegistration ? [4, f.ServiceWorkerManager.getRegistration()] : [2, !1];
              case 1:
                return [2, !e.sent()]
            }
          })
      ...
      }, e.getOneSignalResourceUrlPath = function (t) {
        void 0 === t && (t = e.getBuildEnv());
        var n, i = e.getOneSignalApiUrl(t).origin;
        switch (t) {
          case s.BuildEnvironmentKind.Development:
          case s.BuildEnvironmentKind.Staging:
          case s.BuildEnvironmentKind.Production:
        ...
        return new URL(i + n)
      }, e.getOneSignalCssFileName = function (t) {
        void 0 === t && (t = e.getBuildEnv());
        switch (t) {
          case s.BuildEnvironmentKind.Development:
  ...
  (function (e) {
    ...
    function m() {
      ...
      return !s.default.safari && (!(v() && "localhost" === location.hostname || "127.0.0.1" === location.hostname) && !(c.default.getWindowEnv() !== l.WindowEnvironmentKind.Host && c.default.getWindowEnv() !== l.WindowEnvironmentKind.CustomIframe || !OneSignal.config.subdomain && "http:" !== location.protocol))
    }
    ...
    t.decodeHtmlEntities = function (e) {
    ...
    }, t.isLocalhostAllowedAsSecureOrigin = v, t.awaitOneSignalInitAndSupported = function () {
      return i(this, void 0, void 0, function () {
        return r(this, function (e) {
    ...
    }, t.isUsingSubscriptionWorkaround = m, t.triggerNotificationPermissionChanged = function (e) {
      return void 0 === e && (e = !1), i(this, void 0, void 0, function () {
        var t, n, i;
        return r(this, function (r) {
          switch (r.label) {
            case 0:
              return [4, OneSignal.privateGetNotificationPermission()];
            case 1:
      ...
      if ("string" == typeof e) {
        ...
        if (null === n) throw new Error('Cannot find element with selector "' + e + '"');
        n.classList.add(t)
      } else {
        if ("object" != typeof e) throw new Error(e + " must be a CSS selector string or DOM Element object.");
        e.classList.add(t)
          ...
          switch (n.label) {
            case 0:
              return [4, new Promise(function (n) {
                OneSignal.emitter.once(e, function (e) {
                  t ? t(e) && n(e) : n(e)
                })
              })];
            case 1:
  ...
  var o = function (e) {
    function t(n) {
      ...
      return Object.defineProperty(i, "message", {
        ...
        writable: !0
      }), Error.hasOwnProperty("captureStackTrace") ? (Error.captureStackTrace(i, i.constructor), i) : (Object.defineProperty(i, "stack", {
        configurable: !0,
        enumerable: !1,
  ...
  var r = i(n(0)),
    ...
    s = function () {
      ...
      return e.isBrowser = function () {
        ...
        return "667d417dfeaee00d71566761c096042f"
      }, e
    }();
  t.default = s
}, function (e, t, n) {
  ...
  var s = o(n(5)),
    ...
    h = function () {
      function e() {}
      return e.trigger = function (t, n, o) {
        return void 0 === o && (o = null), i(this, void 0, void 0, function () {
          var i, h, g;
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                if (c.contains(d, t) || (i = n, h = o ? c.capitalize(a.default.getWindowEnv().toString()) + " â¬¸ " + c.capitalize(o) : c.capitalize(a.default.getWindowEnv().toString()), i || !1 === i ? l.default.debug("(" + h + ") Â» %c" + t + ":", c.getConsoleStyle("event"), i) : l.default.debug("(" + h + ") Â» %c" + t, c.getConsoleStyle("event"))), !s.default.isBrowser()) return [3, 2];
                if (t === OneSignal.EVENTS.SDK_INITIALIZED) {
                  if (OneSignal.initialized) return [2];
                  OneSignal.initialized = !0
                }
                return [4, OneSignal.emitter.emit(t, n)];
              case 1:
                r.sent(), r.label = 2;
              case 2:
                return p.hasOwnProperty(t) && (g = p[t], e._triggerLegacy(g, n)), !s.default.isBrowser() || a.default.getWindowEnv() !== u.WindowEnvironmentKind.OneSignalSubscriptionPopup && a.default.getWindowEnv() !== u.WindowEnvironmentKind.OneSignalProxyFrame || (opener || parent ? c.contains(f, t) && (a.default.getWindowEnv() === u.WindowEnvironmentKind.OneSignalSubscriptionPopup ? OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, {
                  eventName: t,
                  eventData: n
                }) : OneSignal.proxyFrame.retriggerRemoteEvent(t, n)) : l.default.error("Could not send event '" + t + "' back to host page because no creator (opener or parent) found!")), [2]
            }
          })
        })
  ...
  i = function () {
    ...
    function t(t) {
      ...
      var i, r, o, s = n(/(ipod|iphone|ipad)/i).toLowerCase(),
        ...
        v = !s && !d && /macintosh/i.test(t),
        m = !a && !f && !p && !h && /linux/i.test(t),
        S = n(/edge\/(\d+(\.\d+)?)/i),
        y = n(/version\/(\d+(\.\d+)?)/i),
  ...
  }, void 0 !== e && e.exports ? e.exports = i() : n(65)("bowser", i)
}, function (e, t, n) {
  "use strict";
  var i = this && this.__awaiter || function (e, t, n, i) {
      return new(n || (n = Promise))(function (r, o) {
  ...
  var v = function () {
    ...
    }, e.prototype.setProvideUserConsent = function (e) {
      return i(this, void 0, void 0, function () {
        return r(this, function (t) {
          switch (t.label) {
            case 0:
              return [4, this.put("Options", {
                key: "userConsent",
                value: e
              })];
            case 1:
    ...
    }, e.prototype.getProvideUserConsent = function () {
      return i(this, void 0, void 0, function () {
        return r(this, function (e) {
          switch (e.label) {
            case 0:
              return [4, this.get("Options", "userConsent")];
            case 1:
              return [2, e.sent()]
          }
        })
    ...
    }, e.setProvideUserConsent = function (t) {
      return i(this, void 0, void 0, function () {
        return r(this, function (n) {
          return e.ensureSingletonInstance(), [2, e.databaseInstance.setProvideUserConsent.call(e.databaseInstance, t)]
        })
      })
    }, e.getProvideUserConsent = function () {
      return i(this, void 0, void 0, function () {
        return r(this, function (t) {
          return e.ensureSingletonInstance(), [2, e.databaseInstance.getProvideUserConsent.call(e.databaseInstance)]
        })
      })
  ...
  var s = function (e) {
    function t() {
      var n = e.call(this, "This code is not implemented yet.") || this;
            ...
            switch (n.label) {
              case 0:
                return [4, new Promise(function (n, i) {
                  c.default.getWindowEnv() !== f.WindowEnvironmentKind.ServiceWorker ? e.jsonpLib(c.default.getOneSignalApiUrl().toString() + "/sync/" + t + "/web", function (e, t) {
  ...
  var PushPermissionNotGrantedError = function (e) {
    function PushPermissionNotGrantedError(n) {
      ...
      return i.reason = n, Object.setPrototypeOf(i, PushPermissionNotGrantedError.prototype), i
    }
    ...
    function InvalidStateError(n, i) {
      ...
      switch (n) {
        ...
        case t.InvalidStateReason.RedundantPermissionMessage:
          var o = "";
          i && i.permissionPromptType && (o = "(" + u.PermissionPromptType[i.permissionPromptType] + ")"), r = e.call(this, "Another permission message " + o + " is being displayed.") || this;
          break;
      ...
      return r.description = t.InvalidStateReason[n], r.reason = n, Object.setPrototypeOf(r, InvalidStateError.prototype), r
    }
  ...
  var O = function () {
    ...
    return e.getRegistration = function () {
      return i(this, void 0, void 0, function () {
        return r(this, function (e) {
          switch (e.label) {
            case 0:
              return e.trys.push([0, 2, , 3]), [4, navigator.serviceWorker.getRegistration(location.href)];
            case 1:
              return [2, e.sent()];
            case 2:
              return e.sent(), m.default.warn("[Service Worker Status] Error Checking service worker registration"), [2, null];
            case 3:
              return [2]
          }
        })
      ...
      return i(this, void 0, void 0, function () {
        ...
        return r(this, function (r) {
          switch (r.label) {
            ...
            case 1:
              return (n = r.sent()) !== g.IntegrationKind.InsecureProxy ? [3, 2] : [2, t.ServiceWorkerActiveState.Indeterminate];
            case 2:
              if (n !== g.IntegrationKind.SecureProxy) return [3, 8];
              switch (i = d.default.getWindowEnv(), i) {
              ...
              return [3, 8];
            case 3:
              return (o = OneSignal.proxyFrameHost) ? [3, 4] : [2, t.ServiceWorkerActiveState.Indeterminate];
            case 4:
            ...
            case 7:
              throw new v.default;
            case 8:
              return [4, e.getRegistration()];
            case 9:
              return (s = r.sent()) ? s.installing ? [2, t.ServiceWorkerActiveState.Installing] : s.active ? (a = new URL(s.active.scriptURL).pathname, u = new l.default(a).getFileName() == this.config.workerAPath.getFileName() ? t.ServiceWorkerActiveState.WorkerA : new l.default(a).getFileName() == this.config.workerBPath.getFileName() ? t.ServiceWorkerActiveState.WorkerB : t.ServiceWorkerActiveState.ThirdParty, navigator.serviceWorker.controller || u !== t.ServiceWorkerActiveState.WorkerA && u !== t.ServiceWorkerActiveState.WorkerB ? [2, u] : [2, t.ServiceWorkerActiveState.Bypassed]) : [2, t.ServiceWorkerActiveState.ThirdParty] : [2, t.ServiceWorkerActiveState.None]
          }
        })
      })
      ...
      return i(this, void 0, void 0, function () {
        ...
        return r(this, function (i) {
          switch (i.label) {
            ...
            case 1:
              e = i.sent(), m.default.info("[Service Worker Update] Checking service worker version..."), i.label = 2;
            case 2:
              return i.trys.push([2, 4, , 5]), [4, p.timeoutPromise(this.getWorkerVersion(), 2e3)];
            case 3:
              return n = i.sent(), [3, 5];
            case 4:
              return i.sent(), m.default.info("[Service Worker Update] Worker did not reply to version query; assuming older version."), n = 1, [3, 5];
            case 5:
              return e !== t.ServiceWorkerActiveState.WorkerA && e !== t.ServiceWorkerActiveState.WorkerB ? (m.default.debug("[Service Worker Update] Not updating service worker, current active worker state is " + e + "."), [2]) : n === a.default.version() ? [3, 7] : (m.default.info("[Service Worker Update] Updating service worker from v" + n + " --\x3e v" + a.default.version() + "."), [4, this.installWorker()]);
            case 6:
              return i.sent(), [3, 8];
            case 7:
              m.default.info("[Service Worker Update] Service worker version is current at v" + n + " (no update required)."), i.label = 8;
            case 8:
              return [2]
          }
        })
        ...
        return r(this, function (o) {
          switch (o.label) {
            ...
            case 5:
              o.sent(), o.label = 6;
            case 6:
              return [4, this.establishServiceWorkerChannel()];
            case 7:
              return o.sent(), [2]
          }
        })
      ...
      return i(this, void 0, void 0, function () {
        var e, t = this;
        return r(this, function (n) {
          return (e = this.context.workerMessenger).off(), e.on(c.WorkerMessengerCommand.NotificationDisplayed, function (e) {
            m.default.debug(location.origin, "Received notification display event from service worker."), S.default.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
          }), e.on(c.WorkerMessengerCommand.NotificationClicked, function (e) {
              ...
              return r(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return t = i.sent(), [3, 3];
                  case 2:
                    t = OneSignal.emitter.numberOfListeners(OneSignal.EVENTS.NOTIFICATION_CLICKED), i.label = 3;
                  case 3:
                    return 0 !== t ? [3, 5] : (m.default.debug("notification.clicked event received, but no event listeners; storing event in IndexedDb for later retrieval."), n = e.url, e.url || (n = location.href), [4, h.default.put("NotificationOpened", {
                      url: n,
                      data: e,
                      timestamp: Date.now()
                    })]);
                  case 4:
                    return i.sent(), [3, 6];
                  case 5:
                    S.default.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e), i.label = 6;
                  case 6:
                    return [2]
                }
              })
            })
          }), e.on(c.WorkerMessengerCommand.RedirectPage, function (e) {
            m.default.debug(d.default.getWindowEnv().toString() + " Picked up command.redirect to " + e + ", forwarding to host page.");
            var t = OneSignal.proxyFrame;
            t && t.messenger.message(OneSignal.POSTMAM_COMMANDS.SERVICEWORKER_COMMAND_REDIRECT, e)
          }), e.on(c.WorkerMessengerCommand.NotificationDismissed, function (e) {
            S.default.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e)
          }), [2]
        })
      })
    }, e.getServiceWorkerHref = function (e, n) {
      var i = "";
      if (e === t.ServiceWorkerActiveState.WorkerA) i = n.workerBPath.getFullPath();
      else if (e === t.ServiceWorkerActiveState.WorkerB || e === t.ServiceWorkerActiveState.ThirdParty || e === t.ServiceWorkerActiveState.None) i = n.workerAPath.getFullPath();
      else if (e === t.ServiceWorkerActiveState.Bypassed) throw new u.InvalidStateError(u.InvalidStateReason.UnsupportedEnvironment);
      return new URL(i, w.default.getBaseUrl()).href
        ...
        return r(this, function (r) {
          switch (r.label) {
            case 0:
              return [4, this.getActiveState()];
            case 1:
              return (n = r.sent()) !== t.ServiceWorkerActiveState.ThirdParty ? [3, 4] : [4, e.getRegistration()];
            case 2:
              return (i = r.sent()) ? [4, i.unregister()] : [3, 4];
            case 3:
              r.sent(), r.label = 4;
            case 4:
              o = e.getServiceWorkerHref(n, this.config), s = p.encodeHashAsUriComponent({
                appId: this.context.appConfig.appId
              }), a = o + "?" + s, m.default.info("[Service Worker Installation] Installing service worker " + a + "."), r.label = 5;
            case 5:
              return r.trys.push([5, 7, , 9]), [4, navigator.serviceWorker.register(a, {
                scope: "" + w.default.getBaseUrl() + this.config.registrationOptions.scope
              })];
            case 6:
              return r.sent(), [3, 9];
            case 7:
              if (u = r.sent(), m.default.error("[Service Worker Installation] Installing service worker failed " + u), d.default.getWindowEnv() === b.WindowEnvironmentKind.OneSignalSubscriptionPopup) throw u;
              return [4, fetch(a)];
            case 8:
              if (403 === (c = r.sent()).status || 404 === c.status) throw new y.default(c.status, c.statusText);
              throw u;
            case 9:
              return m.default.debug("[Service Worker Installation] Service worker installed."), [2]
          }
        })
      })
    }, e
  }();
  t.ServiceWorkerManager = O
}, function (e, t, n) {
  "use strict";
  var i, r = this && this.__extends || (i = Object.setPrototypeOf || {
        __proto__: []
  ...
  var InvalidArgumentError = function (e) {
    function InvalidArgumentError(n, i) {
      ...
      return r.argument = n, r.reason = t.InvalidArgumentReason[i], Object.setPrototypeOf(r, InvalidArgumentError.prototype), r
    }
  ...
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), (i = t.SubscriptionStateKind || (t.SubscriptionStateKind = {}))[i.Subscribed = 1] = "Subscribed", i[i.MutedByApi = -2] = "MutedByApi", i[i.NotSubscribed = -10] = "NotSubscribed", i[i.TemporaryWebRecord = -20] = "TemporaryWebRecord", i[i.PermissionRevoked = -21] = "PermissionRevoked", i[i.PushSubscriptionRevoked = -22] = "PushSubscriptionRevoked", i[i.ServiceWorkerStatus403 = -23] = "ServiceWorkerStatus403", i[i.ServiceWorkerStatus404 = -24] = "ServiceWorkerStatus404"
}, function (e, t, n) {
  "use strict";
  var i;
  Object.defineProperty(t, "__esModule", {
  ...
  var p = function () {
    ...
    return e.prototype.addListener = function (e, t, n) {
      ...
      r ? r.push(i) : this.replies[e.toString()] = [i]
  ...
  var h = function () {
    function e(e, t) {
      void 0 === t && (t = new p), this.context = e, this.replies = t, this.debug = !0
    }
    return e.prototype.broadcast = function (e, t) {
      ...
      return i(this, void 0, void 0, function () {
        return r(this, function (t) {
          switch (t.label) {
            case 0:
              return d.default.supportsServiceWorkers() ? u.default.getWindowEnv() !== l.WindowEnvironmentKind.ServiceWorker ? [3, 1] : (self.addEventListener("message", this.onWorkerMessageReceivedFromPage.bind(this)), f.default.debug("[Worker Messenger] Service worker is now listening for messages."), [3, 3]) : [2];
            case 1:
              return [4, this.listenForPage(e)];
            case 2:
              t.sent(), t.label = 3;
            case 3:
              return [2]
  ...
  var SdkInitError = function (e) {
    function SdkInitError(n, i) {
      ...
      return r.reason = t.SdkInitErrorKind[n], Object.setPrototypeOf(r, SdkInitError.prototype), r
    }
  ...
  var s = o(n(7)),
    ...
    G = function () {
      ...
      return e.setDefaultNotificationUrl = function (e) {
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                if (!W.ValidatorUtils.isValidUrl(e, {
                    allowNull: !0
                  })) throw new c.InvalidArgumentError("url", c.InvalidArgumentReason.Malformed);
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), D.logMethodCall("setDefaultNotificationUrl", e), [4, x.default.getAppState()];
              case 2:
                return (t = n.sent()).defaultNotificationUrl = e, [4, x.default.setAppState(t)];
              case 3:
                return n.sent(), [2]
            }
          })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), D.logMethodCall("setDefaultTitle", e), [4, x.default.getAppState()];
              case 2:
                return (t = n.sent()).defaultNotificationTitle = e, [4, x.default.setAppState(t)];
              case 3:
                return n.sent(), [2]
            }
          })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                ...
                if (!D.isValidEmail(e)) throw new c.InvalidArgumentError("email", c.InvalidArgumentReason.Malformed);
                ...
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("setEmail", e, t), [4, x.default.getAppConfig()];
              case 2:
                return n = r.sent(), [4, x.default.getSubscription()];
              case 3:
                return i = r.sent().deviceId, [4, x.default.getEmailProfile()];
              case 4:
                ...
                return (s = new j.EmailProfile).emailId = o.emailId, s.emailAddress = e, t && t.emailAuthHash && (s.emailAuthHash = t.emailAuthHash), (a = !!o.emailId) && n.emailAuthRequired ? (u = s, [4, A.default.updateEmailRecord(n, s, i)]) : [3, 6];
              case 5:
              ...
              case 9:
                r.sent(), r.label = 10;
              case 10:
                return [4, x.default.setEmailProfile(s)];
              case 11:
                return r.sent(), [2, s.emailId]
            }
          })
        })
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return i.sent(), [4, x.default.getAppConfig()];
              case 2:
                return e = i.sent(), [4, x.default.getEmailProfile()];
              case 3:
                return t = i.sent(), [4, x.default.getSubscription()];
              case 4:
                return n = i.sent().deviceId, t.emailId ? n ? [4, A.default.logoutEmail(e, t, n)] : (F.default.warn(new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2]) : (F.default.warn(new d.NotSubscribedError(d.NotSubscribedReason.NoEmailSet)), [2]);
              case 5:
                return i.sent() ? [4, x.default.setEmailProfile(new j.EmailProfile)] : (F.default.warn("Failed to logout email."), [2]);
              case 6:
                return i.sent(), [2]
            }
          })
        ...
        return D.logMethodCall("isPushNotificationsSupported"), !0
      }, e.init = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return D.logMethodCall("init"), [4, S.default.ponyfillSafariFetch()];
              case 1:
                return n.sent(), S.default.errorIfInitAlreadyCalled(), [4, S.default.initializeConfig(t)];
              case 2:
                return n.sent(), s.default.safari && !e.config.safariWebId ? (F.default.warn(new g.SdkInitError(g.SdkInitErrorKind.MissingSafariWebId)), [2]) : e.config.userConfig.requiresUserPrivacyConsent ? [4, x.default.getProvideUserConsent()] : [3, 4];
              case 3:
                if (!n.sent()) return e.pendingInit = !0, [2];
                n.label = 4;
              case 4:
                return [4, e.delayedInit()];
              case 5:
                return n.sent(), [2]
            }
          })
        })
      }, e.delayedInit = function () {
        return i(this, void 0, void 0, function () {
          function t() {
            return i(this, void 0, void 0, function () {
              var t;
              return r(this, function (n) {
                switch (n.label) {
                  case 0:
                    ...
                    if (e.__initAlreadyCalled = !0, y.default.fixWordpressManifestIfMisplaced(), e.emitter.on(e.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, v.default.onNotificationPermissionChange), e.emitter.on(e.EVENTS.SUBSCRIPTION_CHANGED, v.default._onSubscriptionChanged), e.emitter.on(e.EVENTS.SDK_INITIALIZED, S.default.onSdkInitialized), !D.isUsingSubscriptionWorkaround()) return [3, 2];
                    if (e.appConfig = e.config, !e.appConfig.subdomain) throw new g.SdkInitError(g.SdkInitErrorKind.MissingSubdomain);
                    return t = e, [4, E.default.discoverAltOrigin(e.appConfig)];
                  case 1:
                  ...
                  case 2:
                    ...
                    }), [4, S.default.initSaveState(document.title)];
                  case 3:
                    return n.sent(), [4, S.default.saveInitOptions()];
                  case 4:
                    return n.sent(), I.default.getWindowEnv() !== M.WindowEnvironmentKind.CustomIframe ? [3, 6] : [4, b.default.trigger(e.EVENTS.SDK_INITIALIZED)];
                  case 5:
                    return n.sent(), [3, 8];
                  case 6:
                    return [4, S.default.internalInit()];
                  case 7:
                    n.sent(), n.label = 8;
                  case 8:
                    return [2]
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return e.pendingInit = !1, e.context.workerMessenger.listen(), "complete" !== document.readyState && "interactive" !== document.readyState ? [3, 2] : [4, t()];
              case 1:
                return n.sent(), [3, 3];
              case 2:
                F.default.debug("OneSignal: Waiting for DOMContentLoaded or readyStateChange event before continuing initialization..."), window.addEventListener("DOMContentLoaded", function () {
                  t()
      ...
      }, e.provideUserConsent = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, x.default.setProvideUserConsent(t)];
              case 1:
                return n.sent(), t && e.pendingInit ? [4, e.delayedInit()] : [3, 3];
              case 2:
                n.sent(), n.label = 3;
              case 3:
                return [2]
        ...
        return i(this, void 0, void 0, function () {
          return r(this, function (t) {
            return F.default.debug("Called showHttpPermissionRequest(), redirecting to HTTP prompt."), e.showHttpPrompt().catch(function (e) {
              return F.default.info(e)
            }), [2]
          })
        })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), [4, e.privateShowHttpPrompt(t)];
              case 2:
                return n.sent(), [2]
            }
          })
        })
      }, e.privateShowHttpPrompt = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                if (t || (t = {}), e.__isPopoverShowing) throw new l.InvalidStateError(l.InvalidStateReason.RedundantPermissionMessage, {
                  permissionPromptType: k.PermissionPromptType.SlidedownPermissionMessage
                });
                return [4, y.default.wasHttpsNativePromptDismissed()];
              case 1:
                return n.sent() && !t.force ? (F.default.info(new f.default), [2]) : [4, e.privateGetNotificationPermission()];
              case 2:
                return n.sent() === C.NotificationPermission.Denied ? (F.default.info(new p.default(h.PushPermissionNotGrantedErrorReason.Blocked)), [2]) : [4, e.privateIsPushNotificationsEnabled()];
              case 3:
                if (n.sent()) throw new u.default;
                return [4, e.privateGetSubscription()];
              case 4:
                if (!n.sent()) throw new d.NotSubscribedError(d.NotSubscribedReason.OptedOut);
                return y.default.markHttpPopoverShown(), [4, e.context.dynamicResourceLoader.loadSdkStylesheet()];
              case 5:
                return 0 !== n.sent() ? (F.default.debug("Not showing slidedown permission message because styles failed to load."), [2]) : (e.popover = new N.default(y.default.getSlidedownPermissionMessageOptions()), [4, e.popover.create()]);
              case 6:
                return n.sent(), F.default.debug("Showing the HTTP popover."), e.notifyButton && e.notifyButton.options.enable && "hidden" !== e.notifyButton.launcher.state && e.notifyButton.launcher.waitUntilShown().then(function () {
                  e.notifyButton.launcher.hide()
                }), e.emitter.once(N.default.EVENTS.SHOWN, function () {
                  e.__isPopoverShowing = !0
                }), e.emitter.once(N.default.EVENTS.CLOSED, function () {
                  e.__isPopoverShowing = !1, e.notifyButton && e.notifyButton.options.enable && e.notifyButton.launcher.show()
                }), e.emitter.once(N.default.EVENTS.ALLOW_CLICK, function () {
                  e.popover.close(), F.default.debug("Setting flag to not show the popover to the user again."), O.default.markHttpsNativePromptDismissed(), e._sessionInitAlreadyRunning = !1, e.registerForPushNotifications({
                    autoAccept: !0
                  })
                }), e.emitter.once(N.default.EVENTS.CANCEL_CLICK, function () {
                  F.default.debug("Setting flag to not show the popover to the user again."), O.default.markHttpsNativePromptDismissed(), e._sessionInitAlreadyRunning = !1
                }), [2]
            }
          })
        })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), [2, e.privateGetNotificationPermission(t)]
            }
          })
        })
      }, e.privateGetNotificationPermission = function (t) {
        return i(this, void 0, void 0, function () {
          var n;
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, e.context.permissionManager.getNotificationPermission(e.config.safariWebId)];
              case 1:
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("getTags", e), [4, x.default.getAppConfig()];
              case 2:
                return t = r.sent().appId, [4, x.default.getSubscription()];
              case 3:
                return (n = r.sent().deviceId) ? [4, A.default.getPlayer(t, n)] : (F.default.info(new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2, null]);
              case 4:
                return i = r.sent().tags, D.executeCallback(e, i), [2, i]
            }
          })
        })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("sendTags", t, n), t && 0 !== Object.keys(t).length ? (Object.keys(t).forEach(function (e) {
                  !1 === t[e] && (t[e] = "false")
                }), [4, x.default.getAppConfig()]) : (F.default.info(new c.InvalidArgumentError("tags", c.InvalidArgumentReason.Empty)), [2, null]);
              case 2:
                return i = r.sent().appId, [4, x.default.getEmailProfile()];
              case 3:
              ...
              case 4:
                r.sent(), r.label = 5;
              case 5:
                return [4, x.default.getSubscription()];
              case 6:
                return r.sent().deviceId ? [3, 8] : [4, D.awaitSdkEvent(e.EVENTS.REGISTERED)];
              case 7:
                r.sent(), r.label = 8;
              case 8:
                return [4, x.default.getSubscription()];
              ...
              case 10:
                return r.sent(), D.executeCallback(n, t), [2, t]
            }
          })
        })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                if (r.sent(), D.logMethodCall("deleteTags", t, n), !W.ValidatorUtils.isValidArray(t)) throw new c.InvalidArgumentError("tags", c.InvalidArgumentReason.Malformed);
                for (0 === t.length && F.default.info(new c.InvalidArgumentError("tags", c.InvalidArgumentReason.Empty)), i = {}, o = 0, s = t; o < s.length; o++) a = s[o], i[a] = "";
                return [4, e.sendTags(i)];
              case 2:
                return u = r.sent(), l = Object.keys(u), D.executeCallback(n, l), [2, l]
            }
          })
        })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), D.logMethodCall("addListenerForNotificationOpened", t), e.emitter.once(e.EVENTS.NOTIFICATION_CLICKED, function (e) {
                  D.executeCallback(t, e)
                }), v.default.fireStoredNotificationClicks(e.config.pageUrl || e.config.userConfig.pageUrl), [2]
            }
          })
        })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("getIdsAvailable", e), [4, x.default.getSubscription()];
              case 2:
                return t = r.sent(), n = t.deviceId, i = t.subscriptionToken, o = {
                  userId: n,
                  registrationId: i
                }, D.executeCallback(e, o), [2, o]
            }
          })
        })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), [2, e.privateIsPushNotificationsEnabled(t)]
            }
          })
        })
      }, e.privateIsPushNotificationsEnabled = function (t) {
        return i(this, void 0, void 0, function () {
          var n;
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return D.logMethodCall("isPushNotificationsEnabled", t), [4, e.context.subscriptionManager.getSubscriptionState()];
              case 1:
                return n = i.sent(), D.executeCallback(t, n.subscribed && !n.optedOut), [2, n.subscribed && !n.optedOut]
            }
          })
        })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("setSubscription", e), [4, x.default.getAppConfig()];
              case 2:
                return t = r.sent(), n = t.appId, [4, x.default.getSubscription()];
              case 3:
                if (i = r.sent(), o = i.deviceId, !t.appId) throw new l.InvalidStateError(l.InvalidStateReason.MissingAppId);
                if (!W.ValidatorUtils.isValidBoolean(e)) throw new c.InvalidArgumentError("newSubscription", c.InvalidArgumentReason.Malformed);
                return o ? (i.optedOut = !e, [4, A.default.updatePlayer(n, o, {
                  notification_types: y.default.getNotificationTypeFromOptIn(e)
                })]) : (F.default.info(new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2]);
              case 4:
                return r.sent(), [4, x.default.setSubscription(i)];
              case 5:
                return r.sent(), v.default.onInternalSubscriptionSet(i.optedOut), v.default.checkAndTriggerSubscriptionChanged(), [2]
            }
          })
        })
      }, e.isOptedOut = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), [2, e.internalIsOptedOut(t)]
            }
          })
        })
      }, e.internalIsOptedOut = function (e) {
        return i(this, void 0, void 0, function () {
          var t;
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return D.logMethodCall("isOptedOut", e), [4, x.default.getSubscription()];
              case 1:
                return t = n.sent().optedOut, D.executeCallback(e, t), [2, t]
            }
          })
        })
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                if (i.sent(), D.logMethodCall("optOut", t, n), !W.ValidatorUtils.isValidBoolean(t)) throw new c.InvalidArgumentError("doOptOut", c.InvalidArgumentReason.Malformed);
                return [4, e.setSubscription(!t)];
              case 2:
                return i.sent(), D.executeCallback(n), [2]
            }
          })
        })
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return i.sent(), D.logMethodCall("getEmailId", e), [4, x.default.getEmailProfile()];
              case 2:
                return t = i.sent(), n = t.emailId, D.executeCallback(e, n), [2, n]
            }
          })
        })
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return i.sent(), D.logMethodCall("getUserId", e), [4, x.default.getSubscription()];
              case 2:
                return t = i.sent(), n = t.deviceId, D.executeCallback(e, n), [2, n]
            }
          })
        })
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return i.sent(), D.logMethodCall("getRegistrationId", e), [4, x.default.getSubscription()];
              case 2:
                return t = i.sent(), n = t.subscriptionToken, D.executeCallback(e, n), [2, n]
            }
          })
        })
      }, e.getSubscription = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return n.sent(), [4, e.privateGetSubscription(t)];
              case 2:
                return [2, n.sent()]
            }
          })
        })
      }, e.privateGetSubscription = function (e) {
        return i(this, void 0, void 0, function () {
          var t, n;
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return D.logMethodCall("getSubscription", e), [4, x.default.getSubscription()];
              case 1:
                return t = i.sent(), n = !t.optedOut, D.executeCallback(e, n), [2, n]
            }
          })
        })
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, D.awaitOneSignalInitAndSupported()];
              case 1:
                return r.sent(), D.logMethodCall("sendSelfNotification", t, n, o, s, a, u), [4, x.default.getAppConfig()];
              case 2:
                return i = r.sent(), [4, x.default.getSubscription()];
              case 3:
              ...
              case 4:
                ...
                if (!W.ValidatorUtils.isValidUrl(o)) throw new c.InvalidArgumentError("url", c.InvalidArgumentReason.Malformed);
                if (!W.ValidatorUtils.isValidUrl(s, {
                    allowEmpty: !0,
                    requireHttps: !0
        ...
        if ("function" == typeof t) t();
          ...
          if (!Array.isArray(t)) throw new V.default("Only accepts function and Array types!");
          if (0 == t.length) throw new V.default("Empty array is not valid!");
          var n = t.shift();
          if (null == n || void 0 === n) throw new V.default("First element in array must be the OneSignal function name");
          var i = e[n.toString()];
          if ("function" != typeof i) throw new V.default("No OneSignal function with the name '" + n + "'");
          i.apply(null, t)
        }
      }, e.on = function (e, t) {
  ...
  }, P.default.ensureBackwardsCompatibility(G), F.default.info("%cOneSignal Web SDK loaded (version " + G._VERSION + ", " + I.default.getWindowEnv().toString() + " environment).", D.getConsoleStyle("bold")), F.default.debug("Current Page URL: " + ("undefined" == typeof location ? "NodeJS" : location.href)), F.default.debug("Browser Environment: " + s.default.name + " " + s.default.version)
}, function (e, t, n) {
  "use strict";
  var i = this && this.__awaiter || function (e, t, n, i) {
      return new(n || (n = Promise))(function (r, o) {
  ...
  var o = function () {
    ...
    return e.prototype.on = function (e, t) {
    ...
    }, e.prototype.numberOfListeners = function (e) {
      ...
      return i(this, void 0, void 0, function () {
        ...
        return r(this, function (r) {
          switch (r.label) {
            case 0:
              if (t = e.shift(), void 0 === (n = this._events[t])) return [3, 4];
              n = n.slice(0), i = n.length, o = 0, r.label = 1;
            case 1:
              return o < i ? [4, n[o].apply(this, e)] : [3, 4];
            case 2:
              r.sent(), r.label = 3;
            case 3:
              return o += 1, [3, 1];
  ...
  var s = o(n(7)),
    ...
    c = function (e) {
      ...
      return r(t, e), t.prototype.serialize = function () {
        ...
        return this.subscription && (t.identifier = s.default.safari ? this.subscription.safariDeviceToken : this.subscription.w3cEndpoint ? this.subscription.w3cEndpoint.toString() : null, t.web_auth = this.subscription.w3cAuth, t.web_p256 = this.subscription.w3cP256dh), t
  ...
  var i = n(1),
    r = function () {
      function e() {}
      return e.getBaseUrl = function () {
        return location.origin
      }, e.getValueOrDefault = function (e, t) {
        return void 0 !== e && null !== e ? e : t
      }, e.isUsingSubscriptionWorkaround = function () {
        return i.isUsingSubscriptionWorkaround()
      }, e
    }();
  t.Utils = r, t.default = r
}, function (e, t, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", {
    value: !0
  ...
  var a, u = n(50),
    ...
    p = n(1),
    h = s(n(26));
  (a = t.IntegrationConfigurationKind || (t.IntegrationConfigurationKind = {}))[a.Dashboard = 0] = "Dashboard", a[a.JavaScript = 1] = "JavaScript";
  var g = function () {
    function e() {}
    return e.prototype.getAppConfig = function (t) {
      return r(this, void 0, void 0, function () {
        var n, i, r;
        return o(this, function (o) {
          switch (o.label) {
            case 0:
              if (o.trys.push([0, 2, , 3]), !t || !t.appId || !p.isValidUuid(t.appId)) throw new l.SdkInitError(l.SdkInitErrorKind.InvalidAppId);
              return [4, c.default.downloadServerAppConfig(t.appId)];
            case 1:
              return n = o.sent(), i = this.getMergedConfig(t, n), e.checkRestrictedOrigin(i), [2, i];
            case 2:
              if (r = o.sent()) {
                if (1 === r.code) throw new l.SdkInitError(l.SdkInitErrorKind.InvalidAppId);
                if (2 === r.code) throw new l.SdkInitError(l.SdkInitErrorKind.AppNotConfiguredForWebPush)
              }
              throw r;
            case 3:
              return [2]
      ...
      switch (e) {
        case u.ConfigIntegrationKind.Custom:
        case u.ConfigIntegrationKind.WordPress:
          return {
      ...
      return e.config.integration ? e.config.integration.kind : u.ConfigIntegrationKind.Custom
    }, e.prototype.getCustomLinkConfig = function (e) {
      var t = {
        enabled: !1,
        style: "button",
        size: "medium",
      ...
      var n = e.config.staticPrompts.customlink;
      return {
        enabled: n.enabled,
        style: n.style,
        size: n.size,
        unsubscribeEnabled: n.unsubscribeEnabled,
        text: n.text ? {
          subscribe: n.text.subscribe,
          unsubscribe: n.text.unsubscribe,
          explanation: n.text.explanation
        } : t.text,
        color: n.color ? {
          button: n.color.button,
          text: n.color.text
        } : t.color
      }
    }, e.prototype.injectDefaultsIntoPromptOptions = function (e, t) {
      if (!e) return e;
      var n = e.customlink || {
          enabled: void 0,
          style: void 0,
          size: void 0,
          unsubscribeEnabled: void 0,
          text: void 0,
          color: void 0
        },
        r = t.customlink;
      return i({}, e, {
        customlink: {
          enabled: h.default.getValueOrDefault(n.enabled, r.enabled),
          style: h.default.getValueOrDefault(n.style, r.style),
          size: h.default.getValueOrDefault(n.size, r.size),
          unsubscribeEnabled: h.default.getValueOrDefault(n.unsubscribeEnabled, r.unsubscribeEnabled),
          text: {
            subscribe: h.default.getValueOrDefault(n.text ? n.text.subscribe : void 0, r.text.subscribe),
            unsubscribe: h.default.getValueOrDefault(n.text ? n.text.unsubscribe : void 0, r.text.unsubscribe),
            explanation: h.default.getValueOrDefault(n.text ? n.text.explanation : void 0, r.text.explanation)
          },
          color: {
            button: h.default.getValueOrDefault(n.color ? n.color.button : void 0, r.color.button),
            text: h.default.getValueOrDefault(n.color ? n.color.text : void 0, r.color.text)
          }
        }
      })
        ...
        case t.IntegrationConfigurationKind.Dashboard:
          return {
            ...
            promptOptions: {
              ...
              customlink: this.getCustomLinkConfig(r)
            },
            welcomeNotification: {
            ...
            requiresUserPrivacyConsent: n.requiresUserPrivacyConsent
          };
        case t.IntegrationConfigurationKind.JavaScript:
          return i({}, n, {
            promptOptions: this.injectDefaultsIntoPromptOptions(n.promptOptions, r.config.staticPrompts)
          }, {
  ...
  var i = function () {
    ...
    return e.prototype.isNewSubscription = function () {
      if (this.existingW3cPushSubscription) {
        if (!!this.existingW3cPushSubscription.w3cEndpoint != !!this.w3cEndpoint) return !1;
        if (this.existingW3cPushSubscription.w3cEndpoint && this.w3cEndpoint && this.existingW3cPushSubscription.w3cEndpoint.toString() !== this.w3cEndpoint.toString()) return !1;
        if (this.existingW3cPushSubscription.w3cP256dh !== this.w3cP256dh) return !1;
        if (this.existingW3cPushSubscription.w3cAuth !== this.w3cAuth) return !1
      } else if (this.existingSafariDeviceToken) return this.existingSafariDeviceToken !== this.safariDeviceToken;
      return !0
    ...
    function n(i) {
      ...
      switch (i) {
        case t.SubscriptionErrorReason.InvalidSafariSetup:
          r = e.call(this, "The Safari site URL, icon size, or push certificate is invalid, or Safari is in a private session.") || this;
          break;
        case t.SubscriptionErrorReason.Blocked:
          r = e.call(this, "Notification permissions are blocked.") || this;
          break;
        case t.SubscriptionErrorReason.Dismissed:
          r = e.call(this, "The notification permission prompt was dismissed.") || this
      }
  ...
  var s = function (e) {
    function t(n, i) {
      var r = e.call(this, "Registration of a Service Worker failed.") || this;
      return r.status = n, r.statusText = i, Object.setPrototypeOf(r, t.prototype), r
    }
    return r(t, e), t
  }(o(n(4)).default);
  t.ServiceWorkerRegistrationError = s, t.default = s
}, function (e, t) {
  var n;
  n = function () {
    return this
    ...
    v = function () {
      function e(t) {
        ...
        if (this.options = {
          ...
          this.size = this.options.size, this.position = this.options.position, this.text = this.options.text, this.text["tip.state.unsubscribed"] || (this.text["tip.state.unsubscribed"] = "Subscribe to notifications"), this.text["tip.state.subscribed"] || (this.text["tip.state.subscribed"] = "You're subscribed to notifications"), this.text["tip.state.blocked"] || (this.text["tip.state.blocked"] = "You've blocked notifications"), this.text["message.prenotify"] || (this.text["message.prenotify"] = "Click to subscribe to notifications"), this.text["message.action.subscribed"] || (this.text["message.action.subscribed"] = "Thanks for subscribing!"), this.text["message.action.resubscribed"] || (this.text["message.action.resubscribed"] = "You're subscribed to notifications"), this.text["message.action.subscribing"] || (this.text["message.action.subscribing"] = "Click <strong>{{prompt.native.grant}}</strong> to receive notifications"), this.text["message.action.unsubscribed"] || (this.text["message.action.unsubscribed"] = "You won't receive notifications again"), this.text["dialog.main.title"] || (this.text["dialog.main.title"] = "Manage Site Notifications"), this.text["dialog.main.button.subscribe"] || (this.text["dialog.main.button.subscribe"] = "SUBSCRIBE"), this.text["dialog.main.button.unsubscribe"] || (this.text["dialog.main.button.unsubscribe"] = "UNSUBSCRIBE"), this.text["dialog.blocked.title"] || (this.text["dialog.blocked.title"] = "Unblock Notifications"), this.text["dialog.blocked.message"] || (this.text["dialog.blocked.message"] = "Follow these instructions to allow notifications:"), this._launcher = N, this.state = e.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, b.default.emitter.on(e.EVENTS.SUBSCRIBE_CLICK, function () {
            x.dialog.subscribeButton.disabled = !0, x._ignoreSubscriptionState = !0, b.default.setSubscription(!0).then(function () {
              return x.dialog.subscribeButton.disabled = !1, x.dialog.hide()
            }).then(function () {
              return x.message.display(h.default.TYPES.MESSAGE, x.text["message.action.resubscribed"], h.default.TIMEOUT)
            }).then(function () {
              return x._ignoreSubscriptionState = !1, x.launcher.clearIfWasInactive(), x.launcher.inactivate()
            }).then(function () {
              return x.updateState()
            })
          }), b.default.emitter.on(e.EVENTS.UNSUBSCRIBE_CLICK, function () {
            x.dialog.unsubscribeButton.disabled = !0, b.default.setSubscription(!1).then(function () {
              return x.dialog.unsubscribeButton.disabled = !1, x.dialog.hide()
            }).then(function () {
              return x.launcher.clearIfWasInactive(), x.launcher.activate()
            }).then(function () {
              return x.message.display(h.default.TYPES.MESSAGE, x.text["message.action.unsubscribed"], h.default.TIMEOUT)
            }).then(function () {
              return x.updateState()
            })
          }), b.default.emitter.on(e.EVENTS.HOVERING, function () {
            x.hovering = !0, x.launcher.activateIfInactive(), x.message.shown || x.dialog.shown ? x.hovering = !1 : x.message.contentType !== h.default.TYPES.MESSAGE ? new Promise(function (e) {
              if (x.message.queued.length > 0) return x.message.dequeue().then(function (t) {
                x.message.content = t, x.message.contentType = h.default.TYPES.QUEUED, e()
              });
              x.message.content = c.decodeHtmlEntities(x.message.getTipForState()), x.message.contentType = h.default.TYPES.TIP, e()
            }).then(function () {
              return x.message.show()
            }).then(function () {
              x.hovering = !1
            }) : x.hovering = !1
          }), b.default.emitter.on(e.EVENTS.HOVERED, function () {
            x.message.contentType !== h.default.TYPES.MESSAGE && x.dialog.hidden && (x.hovering && (x.hovering = !1, x.message.waitUntilShown().then(function () {
              return c.delay(h.default.TIMEOUT)
            }).then(function () {
              return x.message.hide()
            }).then(function () {
              x.launcher.wasInactive && x.dialog.hidden && (x.launcher.inactivate(), x.launcher.wasInactive = null)
            })), x.message.shown && x.message.hide().then(function () {
              x.launcher.wasInactive && x.dialog.hidden && (x.launcher.inactivate(), x.launcher.wasInactive = null)
            }))
          }), b.default.emitter.on(b.default.EVENTS.SUBSCRIPTION_CHANGED, function (t) {
            return i(x, void 0, void 0, function () {
              ...
              return r(this, function (r) {
                switch (r.label) {
                  ...
                  case 2:
                    return b.default.getNotificationPermission(function (n) {
                      i.setState(t ? e.STATES.SUBSCRIBED : "denied" === n ? e.STATES.BLOCKED : e.STATES.UNSUBSCRIBED, i._ignoreSubscriptionState)
                    }), [2]
                }
              })
            })
          }), b.default.emitter.on(e.EVENTS.STATE_CHANGED, function (t) {
            x.launcher.element && (t.to === e.STATES.SUBSCRIBED ? x.launcher.inactivate() : (t.to === e.STATES.UNSUBSCRIBED || e.STATES.BLOCKED) && x.launcher.activate())
          }), b.default.emitter.on(b.default.EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, function () {
            x.updateState()
          }), this.updateState()
        }
      }
      return Object.defineProperty(e, "EVENTS", {
            ...
            switch (r.label) {
              ...
              case 5:
                ...
                return this.applyOffsetIfSpecified(), this.setCustomColorsIfSpecified(), this.patchSafariSvgFilterBug(), g.default.info("Showing the notify button."), [4, (e ? this.launcher.inactivate() : c.nothing()).then(function () {
                  return b.default.getSubscription()
                }).then(function (t) {
                  ...
                  return c.isUsingSubscriptionWorkaround() && t && !0 !== n && !e && !0 === b.default.config.userConfig.autoRegister && !u.default.isHttpPromptAlreadyShown() ? (g.default.debug("Not showing notify button because popover will be shown."), c.nothing()) : o.launcher.show()
                }).then(function () {
                  return c.delay(o.options.showBadgeAfter)
                }).then(function () {
                  return o.options.prenotify && !e && b.default._isNewVisitor ? o.message.enqueue(o.text["message.prenotify"]).then(function () {
                    return o.badge.show()
                  }) : c.nothing()
                }).then(function () {
        ...
        var t = this;
        Promise.all([b.default.privateIsPushNotificationsEnabled(), b.default.privateGetNotificationPermission()]).then(function (n) {
          var i = n[0],
            r = n[1];
      ...
      return e.prototype.getCache = function () {
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return e = a.default.getOneSignalResourceUrlPath(), t = a.default.getOneSignalCssFileName(), [4, this.loadIfNew(0, new URL(e + "/" + t + "?v=" + u.default.getSdkStylesVersionHash()))];
              case 1:
                return [2, n.sent()]
            }
          })
      ...
      return e.registerForPush = function () {
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return t = OneSignal.context, [4, OneSignal.privateIsPushNotificationsEnabled()];
              case 1:
                ...
                return [3, 21];
              case 2:
                return r.trys.push([2, 7, , 8]), [4, t.subscriptionManager.subscribe(0)];
              case 3:
                return n = r.sent(), [4, t.subscriptionManager.registerSubscription(n)];
              case 4:
                return e = r.sent(), t.sessionManager.incrementPageViewCount(), [4, l.triggerNotificationPermissionChanged()];
              case 5:
                return r.sent(), [4, d.default.checkAndTriggerSubscriptionChanged()];
              case 6:
                return r.sent(), [3, 8];
              case 7:
                return i = r.sent(), h.default.info(i), [3, 8];
              case 8:
                return [3, 22];
              case 9:
              ...
              case 10:
                r.sent(), r.label = 11;
              case 11:
                return r.trys.push([11, 14, , 20]), [4, t.subscriptionManager.subscribe(1)];
              case 12:
              ...
              case 15:
                if (r.sent(), !(b instanceof s.default)) return [3, 19];
                switch (b.reason) {
              ...
              case 19:
                return o ? (window.close(), [2, null]) : [3, 20];
              case 20:
    ...
    var a = s(n(7)),
      ...
      y = function () {
        ...
        return Object.defineProperty(e, "VERSION", {
          ...
          return r(this, void 0, void 0, function () {
            var n, i, r, s, a, u, l, d, g, b, v, m, y, w, O, _, E, P, I, C, k, M;
            return o(this, function (o) {
              switch (o.label) {
                case 0:
                ...
                case 4:
                  l = o.sent(), d = e.shouldOpenNotificationUrl(l), g = !1, b = 0, v = u, o.label = 5;
                case 5:
                  return b < v.length ? (m = v[b], y = m.url, m.isSubdomainIframe ? [4, p.default.get("Options", "lastKnownHostUrl")] : [3, 8]) : [3, 37];
                case 6:
                ...
                case 8:
                  ...
                  if (!(m.isSubdomainIframe && y === l || !m.isSubdomainIframe && m.url === l || "focus" === r && O === _)) return [3, 13];
                  e.workerMessenger.unicast(c.WorkerMessengerCommand.NotificationClicked, n, m), o.label = 9;
                case 9:
                  return o.trys.push([9, 11, , 12]), [4, m.focus()];
                case 10:
                  return o.sent(), [3, 12];
                case 11:
                  return E = o.sent(), S.default.error("Failed to focus:", m, E), [3, 12];
                case 12:
                  return [3, 35];
                case 13:
                  if (!m.isSubdomainIframe) return [3, 21];
                  o.label = 14;
                case 14:
                  return o.trys.push([14, 16, , 17]), S.default.debug("Client is subdomain iFrame. Attempting to focus() client."), [4, m.focus()];
                case 15:
                  return o.sent(), [3, 17];
                case 16:
                  return P = o.sent(), S.default.error("Failed to focus:", m, P), [3, 17];
                case 17:
                ...
                case 18:
                  return o.sent(), e.workerMessenger.unicast(c.WorkerMessengerCommand.RedirectPage, l, m), [3, 20];
                case 19:
                  S.default.debug("Not navigating because link is special."), o.label = 20;
                case 20:
                  return [3, 35];
                case 21:
                  if (!m.navigate) return [3, 32];
                  o.label = 22;
                case 22:
                  return o.trys.push([22, 24, , 25]), S.default.debug("Client is standard HTTPS site. Attempting to focus() client."), [4, m.focus()];
                case 23:
                  return o.sent(), [3, 25];
                case 24:
                  return I = o.sent(), S.default.error("Failed to focus:", m, I), [3, 25];
                case 25:
                ...
                case 29:
                  return [3, 31];
                case 30:
                  return C = o.sent(), S.default.error("Failed to navigate:", m, l, C), [3, 31];
                case 31:
                  return [3, 35];
                case 32:
                ...
                case 40:
                  return [4, p.default.getAppConfig()];
                case 41:
                  return k = o.sent().appId, [4, p.default.getSubscription()];
                case 42:
                  return M = o.sent().deviceId, k && M ? [4, f.default.put("notifications/" + n.id, {
                    app_id: k,
                    player_id: M,
                    opened: !0
                  })] : [3, 44];
          ...
          return r(this, void 0, void 0, function () {
            ...
            return o(this, function (o) {
              switch (o.label) {
                ...
                case 3:
                  return a = o.sent().deviceId, (s = !!a) || !t.oldSubscription ? [3, 7] : [4, f.default.getUserIdFromSubscriptionIdentifier(n, m.PushDeviceRecord.prototype.getDeliveryPlatform(), t.oldSubscription.endpoint)];
                case 4:
                ...
                case 15:
                  return "granted" !== o.sent() ? y = v.SubscriptionStateKind.PermissionRevoked : c || (y = v.SubscriptionStateKind.PushSubscriptionRevoked), [4, r.subscriptionManager.registerSubscription(c, y)];
                case 16:
                  o.sent(), o.label = 17;
                case 17:
                  return [2]
          ...
          return new Promise(function (t) {
            ...
            p.default.get("Ids", "userId").then(function (t) {
              return t ? (S.default.debug("Legacy push signal received, retrieving contents from players/" + t + "/chromeweb_notification"), f.default.get("players/" + t + "/chromeweb_notification")) : (S.default.debug("Tried to get notification contents, but IndexedDB is missing user ID info."), Promise.all([e.getAppId(), self.registration.pushManager.getSubscription().then(function (e) {
                ...
                var t = e[0],
                  n = e[1],
                  i = m.PushDeviceRecord.prototype.getDeliveryPlatform();
    ...
    u = function () {
      ...
      return e.prototype.show = function () {
        ...
        return "shown" === this.state ? Promise.resolve(this) : new Promise(function (n) {
          a.default.emitter.once(e.EVENTS.SHOWN, function (e) {
            if (e === t) return n(t)
          })
        })
        ...
        return "hidden" === this.state ? Promise.resolve(this) : new Promise(function (n) {
          a.default.emitter.once(e.EVENTS.HIDDEN, function (e) {
            if (e === t) return n(t)
          })
        })
    ...
    f = function (e) {
      ...
      return r(t, e), t.prototype.activate = function () {
        ...
        return this.active ? Promise.resolve(this) : new Promise(function (n) {
          d.default.emitter.once(t.EVENTS.ACTIVE, function (t) {
            if (t === e) return n(e)
          })
        })
        ...
        return this.inactive ? Promise.resolve(this) : new Promise(function (n) {
          d.default.emitter.once(t.EVENTS.INACTIVE, function (t) {
            if (t === e) return n(e)
          })
        })
  ...
  var s = n(1),
    ...
    f = function () {
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                return n.sent() ? [4, this.getInterpretedAmbiguousPermission(t)] : [3, 4];
              case 3:
                return [2, n.sent()];
              case 4:
                return [2, t]
      ...
      }, e.prototype.getReportedNotificationPermission = function (t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                return a.default.safari ? [2, e.getSafariNotificationPermission(t)] : s.isUsingSubscriptionWorkaround() ? [4, this.getOneSignalSubdomainNotificationPermission(t)] : [3, 2];
              case 1:
                return [2, n.sent()];
              case 2:
      ...
      }, e.getSafariNotificationPermission = function (e) {
  ...
  var s = o(n(0)),
    a = function () {
      ...
      return Object.defineProperty(e.prototype, "PUBLISHER_ID", {
        ...
        return !!this.context.appConfig.subdomain ? new URL("https://" + this.context.appConfig.subdomain + ".os.tc") : new URL(s.default.getOneSignalApiUrl().origin)
      }, e.prototype.install = function () {
        return i(this, void 0, void 0, function () {
          var e, t, n;
          return r(this, function (i) {
            return window.top !== window ? [2] : (e = this.getFrameOrigin(), this.isFeatureEnabled ? (e.pathname = "/webPushAnalytics", e.search = "sync=true&appId=" + this.PUBLISHER_ID) : e.pathname = "/webPushAnalytics", (t = document.createElement("iframe")).style.display = "none", t.src = e.href, (n = {
              promise: void 0,
              resolver: void 0,
              rejector: void 0
            }).promise = new Promise(function (e, t) {
              n.resolver = e, n.rejector = t
            }), document.body.appendChild(t), t.onload = n.resolver, t.onerror = n.rejector, [2, n.promise])
          })
        })
      }, e
    }();
  ...
  var s = o(n(7)),
    ...
    M = function () {
      ...
      return e.isSafari = function () {
            ...
            switch (r.label) {
              case 0:
                switch (n = y.default.getWindowEnv()) {
                  case v.WindowEnvironmentKind.CustomIframe:
                  case v.WindowEnvironmentKind.Unknown:
                  case v.WindowEnvironmentKind.OneSignalProxyFrame:
                    throw new a.InvalidStateError(a.InvalidStateReason.UnsupportedEnvironment)
                }
                switch (n) {
                  case v.WindowEnvironmentKind.ServiceWorker:
                    return [3, 1];
                  case v.WindowEnvironmentKind.Host:
                  case v.WindowEnvironmentKind.OneSignalSubscriptionModal:
                  case v.WindowEnvironmentKind.OneSignalSubscriptionPopup:
                    return [3, 3]
                }
                return [3, 9];
              case 1:
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return t && (t = g.RawPushSubscription.deserialize(t)), (i = _.PushDeviceRecord.createFromPushSubscription(this.config.appId, t, n)).appId = this.config.appId, [4, this.isAlreadyRegisteredWithOneSignal()];
              case 1:
                return r.sent() ? [4, S.default.getSubscription()] : [3, 6];
              case 2:
                return s = r.sent().deviceId, t && !t.isNewSubscription() ? [3, 4] : [4, m.default.updateUserSession(s, i)];
              case 3:
              ...
              case 5:
                return [3, 8];
              case 6:
                return [4, m.default.createUser(i)];
              case 7:
              ...
              case 10:
                return (u = r.sent()).deviceId = o, u.optedOut = !1, t ? e.isSafari() ? u.subscriptionToken = t.safariDeviceToken : u.subscriptionToken = t.w3cEndpoint ? t.w3cEndpoint.toString() : null : u.subscriptionToken = null, [4, S.default.setSubscription(u)];
              case 11:
                return r.sent(), y.default.getWindowEnv() !== v.WindowEnvironmentKind.ServiceWorker && p.default.trigger(OneSignal.EVENTS.REGISTERED), "undefined" != typeof OneSignal && (OneSignal._sessionInitAlreadyRunning = !1), [2, u]
            }
          })
        })
      }, e.requestPresubscribeNotificationPermission = function () {
        return i(this, void 0, void 0, function () {
          return r(this, function (t) {
            switch (t.label) {
              case 0:
                return [4, e.requestNotificationPermission()];
              case 1:
                return [2, t.sent()]
            }
          })
          ...
          return r(this, function (n) {
            switch (n.label) {
              case 0:
                ...
                throw new w.default;
              case 1:
                return 1 !== e ? [3, 7] : y.default.getWindowEnv() !== v.WindowEnvironmentKind.ServiceWorker ? [3, 5] : [4, S.default.getSubscription()];
              case 2:
                return t = n.sent().deviceId, [4, m.default.updatePlayer(this.context.appConfig.appId, t, {
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return (t = n.sent()).emailId ? [4, m.default.updatePlayer(this.config.appId, e, {
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (i) {
            switch (i.label) {
              ...
              case 1:
                if (n = i.sent(), C.triggerNotificationPermissionChanged(), !n) throw new d.default(f.SubscriptionErrorReason.InvalidSafariSetup);
                return e.setFromSafariSubscription(n), [2, e]
            }
          })
        })
      }, e.prototype.subscribeFcmFromPage = function (t) {
        return i(this, void 0, void 0, function () {
          var n, i, o;
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return y.default.getWindowEnv() === v.WindowEnvironmentKind.ServiceWorker || window.Notification.permission !== h.NotificationPermission.Default ? [3, 5] : [4, p.default.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED)];
              case 1:
                return r.sent(), [4, e.requestPresubscribeNotificationPermission()];
              case 2:
                return (n = r.sent()) !== h.NotificationPermission.Default ? [3, 4] : [4, C.triggerNotificationPermissionChanged(!0)];
              case 3:
                r.sent(), r.label = 4;
              case 4:
                switch (n) {
              ...
              case 6:
                if (!r.sent()) return [3, 14];
                r.label = 7;
              case 7:
                return r.trys.push([7, 9, , 14]), [4, this.context.serviceWorkerManager.installWorker()];
              case 8:
                return r.sent(), [3, 14];
              case 9:
                return (i = r.sent()) instanceof k.default ? 403 !== i.status ? [3, 11] : [4, this.context.subscriptionManager.registerFailedSubscription(b.SubscriptionStateKind.ServiceWorkerStatus403, this.context)] : [3, 13];
              case 10:
                return r.sent(), [3, 13];
              case 11:
                return 404 !== i.status ? [3, 13] : [4, this.context.subscriptionManager.registerFailedSubscription(b.SubscriptionStateKind.ServiceWorkerStatus404, this.context)];
              case 12:
                r.sent(), r.label = 13;
              case 13:
                throw i;
              ...
              case 15:
                return o = r.sent(), I.default.debug("Service worker is ready to continue subscribing."), [4, this.subscribeFcmVapidOrLegacyKey(o.pushManager, t)];
              case 16:
                return [2, r.sent()]
            }
          })
          ...
          return r(this, function (r) {
            switch (r.label) {
              ...
              case 3:
                return [2, r.sent()];
              case 4:
                if (t !== v.WindowEnvironmentKind.Host) return [3, 8];
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return [4, this.context.serviceWorkerManager.getActiveState()];
              case 1:
                return (e = r.sent()) !== E.ServiceWorkerActiveState.WorkerA && e !== E.ServiceWorkerActiveState.WorkerB ? [2, !1] : [4, E.ServiceWorkerManager.getRegistration()];
              case 2:
                return (t = r.sent()) && t.pushManager ? [4, t.pushManager.getSubscription()] : [2, !1];
              case 3:
                return (n = r.sent()) && n.expirationTime ? [4, S.default.getSubscription()] : [2, !1];
              case 4:
                return (i = r.sent().createdAt) || (o = 31536e6, i = (new Date).getTime() + o), s = i + (n.expirationTime - i) / 2, [2, n.expirationTime && ((new Date).getTime() >= n.expirationTime || (new Date).getTime() >= s)]
            }
          })
        })
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              ...
              case 2:
                return s = r.sent(), [4, E.ServiceWorkerManager.getRegistration()];
              case 3:
      ...
      }, e.prototype.registerFailedSubscription = function (e, t) {
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            return t.sessionManager.isFirstPageView() && (t.subscriptionManager.registerSubscription(new g.RawPushSubscription, e), t.sessionManager.incrementPageViewCount()), [2]
          })
        })
      }, e
    }();
    ...
    function n(i) {
      ...
      switch (i) {
        case t.OneSignalApiErrorKind.MissingAppId:
          r = e.call(this, "The API call is missing an app ID.") || this
      }
      return Object.setPrototypeOf(r, n.prototype), r
    }
    return r(n, e), n
  ...
  var s = o(n(6)),
    ...
    h = function () {
      ...
      return e.onNotificationPermissionChange = function () {
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return d.logMethodCall("checkAndTriggerSubscriptionChanged"), [4, u.default.context.subscriptionManager.getSubscriptionState()];
              case 1:
                return t = r.sent(), [4, u.default.privateIsPushNotificationsEnabled()];
              case 2:
                return n = r.sent(), [4, l.default.getAppState()];
              case 3:
                return i = r.sent(), o = i.lastKnownPushEnabled, null === o || n !== o ? (f.default.info("The user's subscription state changed from " + (null === o ? "(not stored)" : o) + " âŸ¶ " + t.subscribed), i.lastKnownPushEnabled = n, [4, l.default.setAppState(i)]) : [2];
              case 4:
                return r.sent(), e.triggerSubscriptionChanged(n), [2]
            }
          })
        })
        ...
        return i(this, void 0, void 0, function () {
          return r(this, function (n) {
            return e.onSubscriptionChanged_showWelcomeNotification(t), e.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate(), e.onSubscriptionChanged_updateCustomLink(), [2]
          })
        })
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (r) {
            switch (r.label) {
              case 0:
                return u.default.__doNotShowWelcomeNotification ? (f.default.debug("Not showing welcome notification because user has previously subscribed."), [2]) : !0 !== e ? [3, 3] : [4, l.default.getSubscription()];
              case 1:
                return t = r.sent().deviceId, [4, l.default.getAppConfig()];
              case 2:
                n = r.sent().appId, i = u.default.config.userConfig.welcomeNotification, o = void 0 !== i && !0 === i.disable, a = void 0 !== i && void 0 !== i.title && null !== i.title ? i.title : "", p = void 0 !== i && void 0 !== i.message && null !== i.message && i.message.length > 0 ? i.message : "Thanks for subscribing!", h = new URL(location.href).origin + "?_osp=do_not_open", g = i && i.url && i.url.length > 0 ? i.url : h, a = d.decodeHtmlEntities(a), p = d.decodeHtmlEntities(p), o || (f.default.debug("Sending welcome notification."), c.default.sendNotification(n, [t], {
                  en: a
                }, {
                  en: p
                }, g, null, {
                  __isOneSignalWelcomeNotification: !0
                }, void 0), s.default.trigger(u.default.EVENTS.WELCOME_NOTIFICATION_SENT, {
                  title: a,
                  message: p,
                  url: g
                })), r.label = 3;
      ...
      }, e.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate = function () {
        return i(this, void 0, void 0, function () {
          var e;
          return r(this, function (t) {
            switch (t.label) {
              case 0:
                return u.default.config.userConfig.notifyButton ? (e = u.default.config.userConfig.notifyButton.displayPredicate) && "function" == typeof e && u.default.notifyButton ? [4, e()] : [3, 2] : [2];
              case 1:
                !1 !== t.sent() ? (f.default.debug("Showing notify button because display predicate returned true."), u.default.notifyButton.launcher.show()) : (f.default.debug("Hiding notify button because display predicate returned false."), u.default.notifyButton.launcher.hide()), t.label = 2;
              case 2:
                return [2]
            }
          })
        })
      }, e.onSubscriptionChanged_updateCustomLink = function () {
        return i(this, void 0, void 0, function () {
          return r(this, function (e) {
            switch (e.label) {
              case 0:
                return u.default.config.userConfig.promptOptions ? [4, p.CustomLink.initialize(u.default.config.userConfig.promptOptions.customlink)] : [3, 2];
              case 1:
                e.sent(), e.label = 2;
              case 2:
                return [2]
        ...
        s.default.trigger(u.default.EVENTS.SUBSCRIPTION_CHANGED, e)
          ...
          function t(e) {
            return i(this, void 0, void 0, function () {
              ...
              return r(this, function (r) {
                switch (r.label) {
                  case 0:
                    return [4, l.default.getAppState()];
                  case 1:
                    return (t = r.sent()).clickedNotifications[e.url] = null, [4, l.default.setAppState(t)];
                  case 2:
                    return r.sent(), n = e.data, (i = e.timestamp) && (Date.now() - i) / 1e3 / 60 > 5 ? [2] : (s.default.trigger(u.default.EVENTS.NOTIFICATION_CLICKED, n), [2])
                }
              })
            })
          }
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, l.default.getAppState()];
              case 1:
                return n = i.sent(), [4, l.default.get("Options", "notificationClickHandlerMatch")];
              case 2:
                if ("origin" !== i.sent()) return [3, 7];
                o = 0, a = Object.keys(n.clickedNotifications), i.label = 3;
              case 3:
                return o < a.length ? (c = a[o], new URL(c).origin !== location.origin ? [3, 5] : [4, t(n.clickedNotifications[c])]) : [3, 6];
              case 4:
                i.sent(), i.label = 5;
              case 5:
                return o++, [3, 3];
              case 6:
                return [3, 11];
              case 7:
                return (d = n.clickedNotifications[e]) ? [4, t(d)] : [3, 9];
              case 8:
                return i.sent(), [3, 11];
              case 9:
                return d || !e.endsWith("/") ? [3, 11] : (f = e.substring(0, e.length - 1), (d = n.clickedNotifications[f]) ? [4, t(d)] : [3, 11]);
              case 10:
                i.sent(), i.label = 11;
              case 11:
                return [2]
  ...
  var TimeoutError = function (e) {
    function TimeoutError(t) {
      ...
      return n.message = t, Object.setPrototypeOf(n, TimeoutError.prototype), n
    }
  ...
  var a = s(n(7)),
    ...
    U = function () {
      ...
      return e.storeInitialValues = function () {
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (i) {
            switch (i.label) {
              case 0:
                return [4, OneSignal.privateIsPushNotificationsEnabled()];
              case 1:
                return e = i.sent(), [4, OneSignal.privateGetNotificationPermission()];
              case 2:
                return t = i.sent(), [4, OneSignal.internalIsOptedOut()];
              case 3:
                return n = i.sent(), f.default.put("subscription.optedOut", n), [4, v.default.put("Options", {
                  key: "isPushEnabled",
                  value: e
                })];
              case 4:
                return i.sent(), [4, v.default.put("Options", {
                  key: "notificationPermission",
                  value: t
                })];
              case 5:
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                return e = OneSignal.context, A.default.debug("Checking subscription expiration..."), [4, e.subscriptionManager.isSubscriptionExpiring()];
              case 1:
                return o.sent() ? [4, h.default.getIntegration()] : (A.default.debug("Subscription is not considered expired."), [2]);
              case 2:
                switch (t = o.sent(), n = h.default.getWindowEnv(), A.default.debug("Subscription is considered expiring. Current Integration:", t), t) {
                  case M.IntegrationKind.Secure:
                    return [3, 3];
                  case M.IntegrationKind.SecureProxy:
                    return [3, 6];
                  case M.IntegrationKind.InsecureProxy:
                    return [3, 11]
                }
                return [3, 13];
              case 3:
              ...
              case 6:
                return n !== g.WindowEnvironmentKind.OneSignalProxyFrame ? [3, 8] : [4, new Promise(function (t) {
                  e.workerMessenger.once(E.WorkerMessengerCommand.SubscribeNew, function (e) {
                    t(T.Subscription.deserialize(e))
                  }), e.workerMessenger.unicast(E.WorkerMessengerCommand.SubscribeNew, e.appConfig)
                })];
              case 7:
                return r = o.sent(), A.default.debug("Finished registering brand new subscription:", r), [3, 10];
              case 8:
              ...
              case 10:
                return [3, 13];
              case 11:
                return [4, v.default.remove("Ids", "registrationId")];
              case 12:
                return o.sent(), A.default.debug("Unsubscribed expiring HTTP subscription by removing registration ID."), [3, 13];
              case 13:
                return [2]
            }
          })
          ...
          return o(this, function (o) {
            switch (o.label) {
              ...
              case 5:
                ...
                o.label = 6;
              case 6:
                return o.trys.push([6, 10, , 11]), [4, W.ServiceWorkerManager.getRegistration()];
              case 7:
                return (i = o.sent()) && i.active ? [4, t.serviceWorkerManager.establishServiceWorkerChannel()] : [3, 9];
              case 8:
                o.sent(), o.label = 9;
              case 9:
                return [3, 11];
              case 10:
                return r = o.sent(), A.default.error(r), [3, 11];
              case 11:
                return [4, e.processExpiringSubscriptions()];
              case 12:
                return o.sent(), [4, e.showNotifyButton()];
              case 13:
                return o.sent(), a.default.safari && !1 === OneSignal.config.userConfig.autoRegister ? [4, OneSignal.isPushNotificationsEnabled()] : [3, 16];
              case 14:
                return o.sent() ? [4, e.sessionInit({
                  __sdkCall: !0
                })] : [3, 16];
              case 15:
                o.sent(), o.label = 16;
              case 16:
                return m.isUsingSubscriptionWorkaround() && t.sessionManager.isFirstPageView() ? (A.default.debug("(" + h.default.getWindowEnv().toString() + ") Updating session info for HTTP site."), [4, OneSignal.isPushNotificationsEnabled()]) : [3, 20];
              case 17:
                return o.sent() ? [4, v.default.getSubscription()] : [3, 20];
              case 18:
                return s = o.sent().deviceId, [4, O.default.updateUserSession(s, new C.PushDeviceRecord(null))];
              case 19:
                o.sent(), o.label = 20;
              case 20:
                return [4, e.updateEmailSessionCount()];
              case 21:
                return o.sent(), [4, t.cookieSyncer.install()];
              case 22:
                return o.sent(), [4, e.showPromptsFromWebConfigEditor()];
              case 23:
                return o.sent(), [4, d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED_PUBLIC)];
              case 24:
                return o.sent(), [2]
            }
          })
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                return !1 !== t.sent() ? (OneSignal.notifyButton = new x.default(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create()) : A.default.debug("Notify button display predicate returned false so not showing the notify button."), [3, 3];
              case 2:
                OneSignal.notifyButton = new x.default(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton.create(), t.label = 3;
              case 3:
                return [2]
            }
          })
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (t) {
            switch (t.label) {
              case 0:
                return OneSignal.context.sessionManager.isFirstPageView() ? [4, v.default.getEmailProfile()] : [3, 3];
              case 1:
                return (e = t.sent()).emailId ? [4, O.default.updateUserSession(e.emailId, new k.EmailDeviceRecord(null, e.emailAuthHash))] : [3, 3];
              case 2:
                t.sent(), t.label = 3;
              case 3:
                return [2]
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return e = OneSignal.config, [4, OneSignal.privateIsPushNotificationsEnabled()];
              case 1:
                return (t = !n.sent() && e.userConfig.promptOptions && e.userConfig.promptOptions.slidedown && e.userConfig.promptOptions.slidedown.autoPrompt) ? [4, OneSignal.internalIsOptedOut()] : [3, 3];
              case 2:
                t = !n.sent(), n.label = 3;
              case 3:
                return t ? [4, OneSignal.privateShowHttpPrompt()] : [3, 5];
              case 4:
                n.sent(), n.label = 5;
              case 5:
                return e.userConfig.promptOptions ? [4, D.CustomLink.initialize(e.userConfig.promptOptions.customlink)] : [3, 7];
              case 6:
                n.sent(), n.label = 7;
              case 7:
                return [2]
            ...
            switch (e.label) {
              ...
              case 1:
                e.sent().onchange = function () {
                  m.triggerNotificationPermissionChanged()
                }, e.label = 2;
              case 2:
                return [2]
            }
        ...
        return r(this, void 0, void 0, function () {
          var e, t;
          return o(this, function (n) {
            return e = [], !1 === OneSignal.config.userConfig.persistNotification ? e.push(v.default.put("Options", {
              key: "persistNotification",
              value: !1
            })) : !0 === OneSignal.config.userConfig.persistNotification ? e.push(v.default.put("Options", {
              key: "persistNotification",
              value: "force"
            })) : e.push(v.default.put("Options", {
              key: "persistNotification",
              value: !0
            })), t = OneSignal.config.userConfig.webhooks, ["notification.displayed", "notification.clicked", "notification.dismissed"].forEach(function (n) {
              t && t[n] ? e.push(v.default.put("Options", {
                key: "webhooks." + n,
                value: t[n]
              })) : e.push(v.default.put("Options", {
                key: "webhooks." + n,
            ...
            }), t && t.cors ? e.push(v.default.put("Options", {
              key: "webhooks.cors",
              value: !0
            })) : e.push(v.default.put("Options", {
              key: "webhooks.cors",
              value: !1
            })), OneSignal.config.userConfig.notificationClickHandlerMatch ? e.push(v.default.put("Options", {
              key: "notificationClickHandlerMatch",
              value: OneSignal.config.userConfig.notificationClickHandlerMatch
            })) : e.push(v.default.put("Options", {
              key: "notificationClickHandlerMatch",
              value: "exact"
            })), OneSignal.config.userConfig.notificationClickHandlerAction ? e.push(v.default.put("Options", {
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return A.default.debug("Called %cinternalInit()", m.getConsoleStyle("code")), [4, (t = OneSignal.context).serviceWorkerManager.updateWorker()];
              case 1:
                return n.sent(), t.sessionManager.incrementPageViewCount(), !sessionStorage.getItem("ONE_SIGNAL_SESSION") || m.isUsingSubscriptionWorkaround() || "denied" != window.Notification.permission && sessionStorage.getItem("ONE_SIGNAL_NOTIFICATION_PERMISSION") != window.Notification.permission ? (sessionStorage.setItem("ONE_SIGNAL_NOTIFICATION_PERMISSION", window.Notification.permission), a.default.safari && !1 === OneSignal.config.userConfig.autoRegister ? (A.default.debug("On Safari and autoregister is false, skipping sessionInit()."), m.isUsingSubscriptionWorkaround() || d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED), [2]) : !1 !== OneSignal.config.userConfig.autoRegister || OneSignal.config.subdomain ? [3, 6] : (A.default.debug("Skipping internal init. Not auto-registering and no subdomain."), [4, d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED)])) : (d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED), [2]);
              case 2:
                return n.sent(), [4, OneSignal.privateIsPushNotificationsEnabled()];
              case 3:
                return !n.sent() || m.isUsingSubscriptionWorkaround() ? [3, 5] : (A.default.info("Because the user is already subscribed and has enabled notifications, we will re-register their GCM token."), [4, y.default.registerForPush()]);
              case 4:
                n.sent(), n.label = 5;
              case 5:
                return [2];
              case 6:
                return "visible" !== document.visibilityState ? (m.once(document, "visibilitychange", function (t, n) {
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (r) {
            switch (r.label) {
              ...
              case 1:
                return t = r.sent(), [4, v.default.put("Ids", {
                  type: "appId",
                  id: t
                })];
              case 2:
                return r.sent(), n = e || document.title || "Notification", [4, v.default.put("Options", {
                  key: "pageTitle",
                  value: n
                })];
              case 3:
                return r.sent(), A.default.info("OneSignal: Set pageTitle to be '" + n + "'."), i = OneSignal.config, [4, v.default.put("Options", {
                  key: "emailAuthRequired",
        ...
        return r(this, void 0, void 0, function () {
          ...
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return t = OneSignal.context.appConfig, A.default.debug("Called %csessionInit(" + JSON.stringify(e) + ")", m.getConsoleStyle("code")), OneSignal._sessionInitAlreadyRunning ? (A.default.debug("Returning from sessionInit because it has already been called."), [2]) : (OneSignal._sessionInitAlreadyRunning = !0, e.modalPrompt && e.fromRegisterFor ? (OneSignal.subscriptionModalHost = new b.default(t.appId, e), [4, OneSignal.subscriptionModalHost.load()]) : [3, 2]);
              case 1:
                return n.sent(), [3, 16];
              case 2:
                return m.isUsingSubscriptionWorkaround() ? [3, 13] : e.__sdkCall && S.default.wasHttpsNativePromptDismissed() ? (A.default.debug("OneSignal: Not automatically showing native HTTPS prompt because the user previously dismissed it."), OneSignal._sessionInitAlreadyRunning = !1, [3, 12]) : [3, 3];
              case 3:
                return m.isUsingSubscriptionWorkaround() ? [4, y.default.registerForPush()] : [3, 5];
              case 4:
                return n.sent(), [3, 12];
              case 5:
                return [4, OneSignal.internalIsOptedOut()];
              case 6:
                return n.sent() ? [3, 11] : (!e || e && !e.fromRegisterFor) && a.default.chrome && Number(a.default.version) >= 63 && (a.default.tablet || a.default.mobile) ? [4, OneSignal.privateShowHttpPrompt()] : [3, 8];
              case 7:
                return n.sent(), [3, 10];
              case 8:
                return [4, y.default.registerForPush()];
              case 9:
                n.sent(), n.label = 10;
              case 10:
                return [3, 12];
              case 11:
                OneSignal._sessionInitAlreadyRunning = !1, n.label = 12;
              case 12:
                return [3, 16];
              case 13:
                return !0 !== OneSignal.config.userConfig.autoRegister && A.default.debug("OneSignal: Not automatically showing popover because autoRegister is not specifically true."), S.default.isHttpPromptAlreadyShown() && A.default.debug("OneSignal: Not automatically showing popover because it was previously shown in the same session."), !0 !== OneSignal.config.userConfig.autoRegister || S.default.isHttpPromptAlreadyShown() ? [3, 15] : [4, OneSignal.privateShowHttpPrompt().catch(function (e) {
                  e instanceof c.InvalidStateError && e.reason === c.InvalidStateReason[c.InvalidStateReason.RedundantPermissionMessage] || e instanceof l.default || e instanceof u.default || e instanceof I.default ? A.default.debug("[Prompt Not Showing]", e) : A.default.info(e)
                })];
              case 14:
                n.sent(), n.label = 15;
              case 15:
                OneSignal._sessionInitAlreadyRunning = !1, n.label = 16;
              case 16:
                return [4, d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED)];
              case 17:
                return n.sent(), [2]
            }
          })
          ...
          return o(this, function (t) {
            switch (t.label) {
              case 0:
                ...
                A.default.debug("Loading fetch polyfill for Safari.."), t.label = 1;
              case 1:
                return t.trys.push([1, 3, , 4]), [4, (new P.DynamicResourceLoader).loadFetchPolyfill()];
              case 2:
                return t.sent(), A.default.debug("Done loading fetch polyfill."), [3, 4];
              case 3:
                return e = t.sent(), A.default.debug("Error loading fetch polyfill:", e), [3, 4];
              case 4:
                return [2]
            }
          })
      ...
      }, e.initializeConfig = function (e) {
        return r(this, void 0, void 0, function () {
          var t;
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, (new R.default).getAppConfig(e)];
              case 1:
                return t = n.sent(), A.default.debug("OneSignal: Final web app config: %c" + JSON.stringify(t, null, 4), m.getConsoleStyle("code")), OneSignal.context = new _.default(t), OneSignal.config = OneSignal.context.appConfig, [2]
            }
          })
        })
      }, e
  ...
  var s = n(1),
    ...
    l = function () {
      ...
      return e.initialize = function (t) {
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return t && t.enabled ? (u.default.info("Inititalize CustomLink"), [4, a.default.context.dynamicResourceLoader.loadSdkStylesheet()]) : [2];
              case 1:
                return 0 !== i.sent() ? (u.default.debug("Not initializing custom link button because styles failed to load."), [2]) : (document.querySelectorAll(e.containerSelector).forEach(function (n) {
                  e.isInitialized(n) || e.injectMarkup(n, t)
                }), [4, a.default.privateIsPushNotificationsEnabled()]);
              case 2:
                return n = i.sent(), document.querySelectorAll(e.subscribeSelector).forEach(function (i) {
                  return e.initSubscribeElement(i, t, n)
                }), document.querySelectorAll(e.explanationSelector).forEach(function (i) {
                  return e.initExplanationElement(i, t, n)
                }), [2]
            }
          })
        })
      }, e.injectMarkup = function (t, n) {
        if (n.text) {
          if (t.innerHTML = "", n.text.explanation) {
            var i = document.createElement("p");
            s.addCssClass(i, e.explanationClass), t.appendChild(i)
          }
          if (n.text.subscribe) {
            var r = document.createElement("button");
            s.addCssClass(r, e.subscribeClass), t.appendChild(r)
          }
          e.markAsInitialized(t)
        } else u.default.error("CustomLink: required property 'text' is missing in the config")
      }, e.initSubscribeElement = function (t, n, o) {
        var a = this;
        n.text && n.text.subscribe && (o || (t.textContent = n.text.subscribe)), n.text && n.text.unsubscribe && o && (t.textContent = n.text.unsubscribe), e.setResetClass(t), e.setStateClass(t, o), e.setStyleClass(t, n), e.setSizeClass(t, n), e.setCustomColors(t, n), !0 !== n.unsubscribeEnabled && s.addCssClass(t, "hide"), t.setAttribute(e.subscriptionStateAttribute, o.toString()), e.isInitialized(t) || (t.addEventListener("click", function () {
          return i(a, void 0, void 0, function () {
            return r(this, function (n) {
              return u.default.info("CustomLink: subscribe clicked"), e.handleClick(t), [2]
            })
          })
        }), e.markAsInitialized(t))
        ...
        return i(this, void 0, void 0, function () {
          ...
          return r(this, function (i) {
            switch (i.label) {
              case 0:
                return "true" === t.getAttribute(e.subscriptionStateAttribute) ? [4, a.default.privateIsPushNotificationsEnabled()] : [3, 4];
              case 1:
                return i.sent() ? [4, a.default.setSubscription(!1)] : [3, 3];
              case 2:
                i.sent(), i.label = 3;
              case 3:
                return [3, 7];
              case 4:
                return c.default.isUsingSubscriptionWorkaround() ? (a.default.registerForPushNotifications(), [3, 7]) : [3, 5];
              case 5:
                return [4, a.default.context.subscriptionManager.getSubscriptionState()];
              case 6:
                if (!(n = i.sent()).subscribed) return a.default.registerForPushNotifications(), [2];
                n.optedOut && a.default.setSubscription(!0), i.label = 7;
              case 7:
                return [2]
            }
          })
        })
      }, e.initExplanationElement = function (t, n, i) {
        n.text && n.text.explanation && (t.textContent = n.text.explanation), e.setResetClass(t), e.setStateClass(t, i), e.setSizeClass(t, n), !0 !== n.unsubscribeEnabled && s.addCssClass(t, "hide")
      }, e.setCustomColors = function (e, t) {
      ...
      }, e.setStateClass = function (e, t) {
        var n = t ? "state-unsubscribed" : "state-subscribed",
          i = t ? "state-subscribed" : "state-unsubscribed";
        s.hasCssClass(e, n) && s.removeCssClass(e, n), s.hasCssClass(e, i) || s.addCssClass(e, i)
      }, e.setStyleClass = function (e, t) {
        if (t && t.style) {
          var n = t.style;
          s.hasCssClass(e, n) || s.addCssClass(e, n)
        }
      }, e.setSizeClass = function (e, t) {
        if (t && t.size) {
          var n = t.size;
          s.hasCssClass(e, n) || s.addCssClass(e, n)
        }
      }, e.setResetClass = function (t) {
        var n = e.resetClass;
        s.hasCssClass(t, n) || s.addCssClass(t, n)
      }, e.markAsInitialized = function (t) {
        t.setAttribute(e.initializedAttribute, "true")
      }, e.isInitialized = function (t) {
        return "true" === t.getAttribute(e.initializedAttribute)
      }, e
    }();
  t.CustomLink = l, l.initializedAttribute = "data-cl-initialized", l.subscriptionStateAttribute = "data-cl-state", l.containerClass = "onesignal-customlink-container", l.containerSelector = "." + l.containerClass, l.subscribeClass = "onesignal-customlink-subscribe", l.subscribeSelector = "." + l.subscribeClass, l.explanationClass = "onesignal-customlink-explanation", l.explanationSelector = "." + l.explanationClass, l.resetClass = "onesignal-reset", t.default = l
}, function (e, t, n) {
  "use strict";
  var i, r = this && this.__extends || (i = Object.setPrototypeOf || {
        __proto__: []
  ...
  var PermissionMessageDismissedError = function (e) {
    function PermissionMessageDismissedError() {
      var t = e.call(this, "The permission message was previously dismissed.") || this;
      return Object.setPrototypeOf(t, PermissionMessageDismissedError.prototype), t
    }
  ...
  var AlreadySubscribedError = function (e) {
    function AlreadySubscribedError() {
      var t = e.call(this, "This operation can only be performed when the user is not subscribed.") || this;
      return Object.setPrototypeOf(t, AlreadySubscribedError.prototype), t
    }
    ...
    function n(i) {
      ...
      switch (i) {
        case t.DeprecatedApiReason.HttpPermissionRequest:
          (r = e.call(this, "The HTTP permission request has been deprecated. Please remove any custom popups from your code.") || this).reportUsage(u.ApiUsageMetricKind.HttpPermissionRequest);
          break;
        case t.DeprecatedApiReason.SyncHashedEmail:
          (r = e.call(this, "API syncHashedEmail() has been deprecated and will be removed in a future SDK release. Please remove any usages from your code.") || this).reportUsage(u.ApiUsageMetricKind.SyncHashedEmail)
      }
      return Object.setPrototypeOf(r, n.prototype), r
    }
  ...
  var s = o(n(5)),
    ...
    d = function () {
      ...
      return Object.defineProperty(e, "LOAD_TIMEOUT_MS", {
        ...
        var t = e.data;
        return l.default.debug("(Reposted from iFrame -> Host) Getting event listener count for ", t), e.reply(OneSignal.emitter.numberOfListeners(t)), !1
    ...
    p = function (e) {
      ...
      return r(t, e), t.prototype.onHovering = function () {
        ...
        if (a.default.trigger(c.default.EVENTS.BELL_CLICK), a.default.trigger(c.default.EVENTS.LAUNCHER_CLICK), !this.bell.message.shown || this.bell.message.contentType != d.default.TYPES.MESSAGE) {
          ...
          return this.bell.unsubscribed ? t ? this.bell.launcher.activateIfInactive().then(function () {
          ...
          }) : (f.default.registerForPushNotifications(), this.bell._ignoreSubscriptionState = !0, f.default.emitter.once(f.default.EVENTS.SUBSCRIPTION_CHANGED, function () {
            ...
            e.bell.showDialogProcedure()
          }) : this.bell.blocked && (s.isUsingSubscriptionWorkaround() ? f.default.registerForPushNotifications() : this.bell.launcher.activateIfInactive().then(function () {
            e.bell.showDialogProcedure()
      ...
      return r(t, e), t.prototype.initialize = function () {
        ...
        return s(this, void 0, void 0, function () {
          return a(this, function (e) {
            return v.default.debug("(" + f.default.getWindowEnv().toString() + ") Successfully established cross-origin communication."), this.finishInitialization(), [2, !1]
          })
        })
        ...
        return s(this, void 0, void 0, function () {
          return a(this, function (t) {
            switch (t.label) {
              case 0:
                return v.default.info("(" + f.default.getWindowEnv().toString() + ") The iFrame has just received initOptions from the host page!"), OneSignal.config = o({}, e.data.hostInitOptions, OneSignal.config, {
              ...
              case 7:
                if (t.sent(), navigator.serviceWorker && "https:" === window.location.protocol) try {
                  ...
                  v.default.error("Error interacting with Service Worker inside an HTTP-hosted iFrame:", e)
                }
        ...
        return s(this, void 0, void 0, function () {
          ...
          return a(this, function (n) {
            switch (n.label) {
              case 0:
                v.default.debug("(Reposted from iFrame -> Host) User unsubscribed but permission granted. Re-prompting the user for push."), n.label = 1;
              case 1:
              ...
              case 3:
                return t = n.sent(), v.default.debug("Failed to unsubscribe from push remotely:", t), [3, 4];
              case 4:
                return [2]
            }
          })
        ...
        return s(this, void 0, void 0, function () {
          return a(this, function (t) {
            switch (t.label) {
              case 0:
                return v.default.debug("(Reposted from iFrame -> Host) Marking prompt as dismissed."), [4, d.default.markHttpsNativePromptDismissed()];
              case 1:
  ...
  var NotSubscribedError = function (e) {
    function NotSubscribedError(n) {
      ...
      return i.reason = t.NotSubscribedReason[n], Object.setPrototypeOf(i, NotSubscribedError.prototype), i
    }
  ...
  t.oneSignalSdkInit = function () {
    ...
    var e;
    if ("undefined" != typeof OneSignal && (e = OneSignal), s.isPushNotificationsSupported() ? window.OneSignal = n(20).default : (o.default.debug("OneSignal: Push notifications are not supported. A stubbed version of the SDK will be initialized."), window.OneSignal = r.default), e) {
      if (!Array.isArray(e)) return void o.default.error("'OneSignal' was not defined as an Array. Skipping pushes");
  ...
  var r = n(91),
    o = n(3);
  i(n(0)).default.getWindowEnv() === o.WindowEnvironmentKind.ServiceWorker ? self.OneSignal = n(48) : r.oneSignalSdkInit()
}]);
